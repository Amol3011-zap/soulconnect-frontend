...
export const METADATA = {
  ...
  '/explore/anxiety': {
    title: 'Anxiety Support: Symptoms, Signs & Coping Techniques | SoulConnect',
    description: 'Understand anxiety symptoms and signs, learn how to calm anxiety with evidence-based techniques, and discover mental health support communities. Expert guidance on managing anxiety and finding help when you need it.',
  ...
  '/explore/overwhelm': {
    title: 'Feeling Overwhelmed? Signs, Causes & How to Cope | SoulConnect',
    description: 'Learn about overwhelm, including common signs, causes, and practical ways to cope. Discover strategies to reduce stress, prioritize tasks, and regain a sense of balance.',
  ...
  '/explore/jealousy': {
    title: 'Jealousy and Insecurity: Signs, Causes & Support | SoulConnect',
    description: 'Learn about jealousy and insecurity in relationships, including common triggers, coping strategies, and ways to build trust and confidence.',
