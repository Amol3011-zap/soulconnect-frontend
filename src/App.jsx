...
// Emotion Library (Phase 4) - now public
const ExploreHub             = lazy(() => import('./pages/explore/ExploreHub'));
...
function AppInner() {
  ...
  const safetyRoutes = (
    <>
      ...
      {/* Explore routes restricted - redirects to home */}
      <Route path="/explore/:emotionSlug"       element={<Navigate to="/" replace />} />
