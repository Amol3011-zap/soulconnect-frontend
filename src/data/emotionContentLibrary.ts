...
export const emotionContentLibrary: EmotionContent[] = [
  ...
  // 14. PERFECTIONISM (already partially added above, but need to format properly)
  {
    ...
    trustSafety: { disclaimer: 'This content is educational and supportive. If perfectionism is causing significant distress or is linked to anxiety, depression, or obsessive thoughts, consider speaking with a mental health professional.', lastReviewedDate: '2026-07-17' },
  },
