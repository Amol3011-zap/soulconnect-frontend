...
export const emotionContentLibrary: EmotionContent[] = [
  ...
  // 14. PERFECTIONISM (already partially added above, but need to format properly)
  {
    ...
    hero: { title: 'Perfectionism holding you back?', subtitle: 'Perfectionism feels protective but it\'s exhausting. Progress beats perfection every time.' },
    ...
    trustSafety: { disclaimer: 'This content is supportive. If perfectionism is tied to anxiety or OCD, seek professional help.', lastReviewedDate: '2025-02-15' },
  },
