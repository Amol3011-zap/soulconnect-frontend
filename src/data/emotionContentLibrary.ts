...
export const emotionContentLibrary: EmotionContent[] = [
  ...
  // 14. PERFECTIONISM (already partially added above, but need to format properly)
  {
    ...
    summary: 'Perfectionism is the relentless pursuit of flawlessness and high standards. It leads to procrastination, burnout, anxiety, and missed opportunities. Perfectionism feels motivating but actually limits you. The key shift: aiming for excellence while accepting good enough.',
  ...
  // 15-25: REMAINING EMOTIONS (condensed format for token efficiency)
  {
    ...
    hero: { title: 'Feeling overwhelmed?', subtitle: 'When everything feels urgent and important, nothing gets your real attention. Simplifying helps.' },
    summary: 'Overwhelm is the feeling that there\'s too much to handle—too many tasks, obligations, decisions, or information. It paralyzes you, creates anxiety, and affects sleep and relationships. The solution isn\'t doing more; it\'s clarifying priorities and simplifying.',
