...
export const emotionContentLibrary: EmotionContent[] = [
  ...
  // 15-25: REMAINING EMOTIONS (condensed format for token efficiency)
  {
    ...
    hero: { title: 'Struggling with overwhelm?', subtitle: 'When everything feels urgent and important, it can become difficult to focus, make decisions, or know where to start. Simplifying and prioritizing can help.' },
