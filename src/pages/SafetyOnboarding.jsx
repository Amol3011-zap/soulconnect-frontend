    ...
    <div style={{
      ...
      <div style={{ position:'relative', zIndex:1, width:'100%', maxWidth:480, padding:'24px 20px', maxHeight:'100vh', overflowY:'auto' }}>
        ...
        <div style={{ display:'flex', alignItems:'center', justifyContent:'center', gap:10, marginBottom:20 }}>
          <div style={{ width:34, height:34, borderRadius:10, background:'linear-gradient(135deg,#6D4AFF,#A78BFA)', display:'flex', alignItems:'center', justifyContent:'center', fontSize:16, boxShadow:'0 4px 14px rgba(109,74,255,0.35)' }}>🪷</div>
