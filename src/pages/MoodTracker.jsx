    ...
    >
      ...
      >
        ...
        <div style={{ padding: '24px 20px 16px', display: 'flex', alignItems: 'center', gap: 12 }}>
          <LotusIcon size={32} color="#7C3AED" />
          <div>
            <div style={{ fontSize: 16, fontWeight: 800, color: '#fff' }}>
              Soul<span style={{ color: '#7C3AED' }}>Connect</span>
            </div>
            <div style={{ fontSize: 10, color: '#A78BFA', letterSpacing: '0.08em', marginTop: 2 }}>
              heal • connect • grow
            </div>
          </div>
        </div>
              ...
              >
                ...
                <span
                  style={{
                    ...
                    color: active ? '#A78BFA' : 'rgba(184, 180, 216, 0.7)',
                  }}
                >
                  {item.label}
                </span>
