...
export default function EmotionLibraryHub() {
  const navigate = useNavigate();
  const { categories, setCategories, setIsLoading, isLoading } = useEmotionLibraryStore();
  ...
  const handleCategoryClick = (category) => {
    navigate(`/emotion-library/category/${category.slug}`, { state: { category } });
  };
