    ...
    return (
      <div className="max-w-lg mx-auto px-4 py-8">
        <div className="animate-pulse space-y-4">
          <div className="h-32 rounded-2xl" style={{ background: 'var(--bg-subtle)' }} />
          <div className="h-48 rounded-2xl" style={{ background: 'var(--bg-subtle)' }} />
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-lg mx-auto px-4 space-y-4">
        ...
        <div className="rounded-2xl overflow-hidden px-5 py-4 flex items-center justify-between"
          ...
          <div>
            ...
            <p className="text-xs mt-0.5" style={{ color: 'var(--text-muted)' }}>Switch between light & dark mode</p>
          </div>
          <ThemeToggle />
        </div>
        ...
        <div className="rounded-2xl overflow-hidden" style={{ background: 'var(--bg-card)', border: '1px solid var(--border)' }}>
          <div className="px-5 py-4 flex items-center justify-between" style={{ borderBottom: '1px solid var(--border-subtle)' }}>
            <h2 className="font-bold" style={{ color: 'var(--text)' }}>Profile Details</h2>
            <button className="text-xs text-purple-500 font-semibold hover:underline">Edit</button>
          </div>
          <div>
            {[
            ...
            <div className="grid grid-cols-2 gap-2 mb-4">
              {[
                ...
                <div key={label} className="flex items-center gap-1.5 text-xs">
                  <span className={free ? 'text-green-500' : 'text-gray-300'}>{free ? '✓' : '✗'}</span>
        ...
        <button onClick={handleLogout}
          className="w-full py-3 rounded-2xl font-semibold text-red-500 text-sm transition-colors hover:opacity-80"
          style={{ background: 'var(--bg-card)', border: '1px solid var(--border)' }}>
          Sign Out
        </button>
